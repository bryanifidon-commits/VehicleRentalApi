...
public interface IBookingService
{
    ...
    Task<BookingResponse> UpdateBookingDatesAsync(Guid id, UpdateBookingDatesRequest request, CancellationToken cancellationToken = default);
    Task UpdateBookingStatusAsync(Guid id, BookingStatus newStatus, CancellationToken cancellationToken = default);
